...
<div class="cart-header">
    ...
    <div class="d-flex progress-block px-4 pb-4 mb-4 justify-content-around">
        {{-- 進度條 --}}
        <div class="d-flex flex-row align-item-center col-sm-4">
        ...
        <div class="d-flex flex-row align-center col-sm-4">
            <div class="progress-title">
        ...
        <div class="d-flex flex-column align-center progress-title col-sm-4">
